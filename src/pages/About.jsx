    ...
    <div className="font-sans mt-20">
      ...
      <section className="bg-white py-16 px-4 md:px-8 lg:px-16 text-center">
        ...
        <p className="text-base md:text-lg lg:text-xl text-gray-700">
          We aim to offer spaces that inspire, empower, and elevate your journey.
        </p>
      </section>
      ...
      <section className="bg-gray-100 py-16 px-4 md:px-8 lg:px-32">
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-6 text-center">Our Business</h2>
        <p className="text-gray-700 text-center mb-8 text-sm md:text-base">
          We are committed to providing the best-in-class coworking spaces that foster collaboration and growth.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-cover">
          ...
          <img src={partner4} alt="Coworking space" className="w-full md:px-8 bg-cover rounded-md h-72" />
        </div>
      </section>
      ...
      {/* Process Section */}
      <section className=" py-16 px-4 md:px-8 lg:px-32">
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-6 text-center">Our Process</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            <h3 className="text-lg md:text-xl font-semibold">Discover</h3>
            <p className="text-gray-600 text-sm md:text-base">
              Understanding your needs and mapping out a plan for optimal space utilization.
            </p>
          </div>
          <div className="text-center">
            <h3 className="text-lg md:text-xl font-semibold">Plan</h3>
            <p className="text-gray-600 text-sm md:text-base">
              Creating detailed strategies to meet your workspace goals effectively.
            </p>
          </div>
          <div className="text-center">
            <h3 className="text-lg md:text-xl font-semibold">Deliver</h3>
            <p className="text-gray-600 text-sm md:text-base">
              Executing the plan with precision and ensuring seamless integration.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-100 px-4 md:px-8 lg:px-32">
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-6 text-center">Perks with Us</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="text-center">
            <MdOutlineBusinessCenter className="text-5xl md:text-6xl mb-4 text-blue-500 mx-auto" />
            <h3 className="text-lg md:text-xl font-semibold">Future Proof on ROI</h3>
            <p className="text-gray-600 text-sm md:text-base">
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg md:text-xl font-semibold ">Industry Experience</h3>
            <p className="text-gray-600 text-sm md:text-base">
