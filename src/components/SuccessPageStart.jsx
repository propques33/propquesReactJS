...
const SuccessPage = () => {
  ...
  return (
    <div className="mt-20 flex items-center justify-center ">
       <Helmet>
        <title>Thank You for Starting Your Coworking Journey</title>
        <meta
          name="description"
          content=" We appreciate your interest in starting a coworking space. Our experts will contact you shortly."
        />
        <link
          rel="canonical"
          href="https://propques.com/start-your-own-coworking-space-thankyou"
        />
      </Helmet>
