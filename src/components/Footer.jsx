      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 py-8 border-t-2 border-b-2 border-blue-600">
          ...
          <div className="flex flex-col items-center md:items-start col-span-1 space-y-4">
            ...
            <p className="text-center md:text-left text-sm leading-relaxed">
              Helping property owners, entrepreneurs, and real estate professionals transform and matchmake spaces into profitable coworking businesses.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/webinar" className="hover:underline">Webinar</Link></li>
              <li><Link to="/partners-with-us" className="hover:underline">Our Partners</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/our-service" className="hover:underline">Our Service</Link></li>
          ...
          <div className="md:border-r-2 border-blue-600 pr-4">
            ...
            <a href="mailto:Buzz@propques.com" className="block mt-2 text-blue-600 hover:underline">Buzz@propques.com</a>
          ...
          <div>
            ...
            <form className="space-y-3">
              ...
              <input type="email" placeholder="E-mail" className="border p-2 rounded w-full" />
              <button className="bg-[#2362AB] text-white py-2 rounded w-full">Subscribe</button>
            </form>
            <div className="flex gap-3 mt-4">
              <a href="https://www.linkedin.com/company/propques/posts/?feedView=all">
                <FaLinkedin size={24} className="text-[#2362AB] hover:text-blue-600" />
              </a>
              <a href="https://www.instagram.com/propques_services/?hl=en">
                <FaInstagram size={24} className="text-[#2362AB] hover:text-blue-600" />
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mt-10 text-sm text-gray-500">
          <p>
            ...
            <Link to="#" className="hover:underline ml-2">Sitemap</Link> | 
